clear
load Output\highbeta\Data.mat
%% RDY_OCorrMZ
HistCell              = 15;
MaxCount              = 0;
FontSize              = 25;
AxisLim               = [0.975 1.0015 0 60];
F1 = figure;
set(F1,'Name','RDY_OCorrMZ_highbeta')
...
F1                    = figure;
set(F1,'Name','WorkerFirmSortingAll_highbeta')
set(F1,'Units','Inches','outerposition',[0 0 11 11]);
set(F1,'PaperOrientation','Landscape');
set(F1,'PaperPositionMode','Auto');
set(F1,'Clipping','off')
...
FontSize              = 25;
TickMark              = 6;
set(F1,'Name','OutputLossesCombined_highbeta')
Group = ProdName < 4;
set(F1,'Units','Inches','outerposition',[0 0 11 11]);
set(F1,'PaperOrientation','Landscape');
set(F1,'PaperPositionMode','Auto');
