clear
load Output\matchquality\Data.mat
%% RDY_OCorrMZ
HistCell              = 10;
MaxCount              = 0;
FontSize              = 25;
AxisLim               = [0.985 1.0005 0 40];
F1 = figure;
set(F1,'Name','RDY_OCorrMZ_matchquality')
...
F1                    = figure;
set(F1,'Name','WorkerFirmSortingAll_matchquality')
set(F1,'Units','Inches','outerposition',[0 0 11 11]);
set(F1,'PaperOrientation','Landscape');
set(F1,'PaperPositionMode','Auto');
set(F1,'Clipping','off')
...
FontSize              = 25;
TickMark              = 6;
set(F1,'Name','OutputLossesCombined_matchquality')
Group = ProdName < 4;
set(F1,'Units','Inches','outerposition',[0 0 11 11]);
set(F1,'PaperOrientation','Landscape');
set(F1,'PaperPositionMode','Auto');
